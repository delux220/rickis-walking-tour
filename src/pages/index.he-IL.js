			...
			<div className="sm:grid grid-cols-2 gap-8">
				{
					tours.map(tour => <div key={`tour-${tour.id}`} className="lg:flex space-x-4 on-scroll mb-6 sm:mb-0">
							...
							<div>
								...
								<a href="https://fareharbor.com/embeds/book/guidedtoursnyc/items/392676/?full-items=yes&flow=775903&u=d0bb4060-6f01-45b4-979d-e5b53f7641bd&from-ssl=yes&ga4t=G-XDVQTYZ0FJ,__%3B&g4=yes&a=yes&back=https://rickiswalkingtours.com/" className="w-full md:w-auto text-xl sm:text-base font-bold font-sans bg-rose-400 mr-4 shadow-lg text-white rounded-full px-6 py-2 block text-center"><FontAwesomeIcon icon={faArrowRight} className="mr-2"/>Book Tour</a>
							</div>
						</div>)
				}
				</div>
