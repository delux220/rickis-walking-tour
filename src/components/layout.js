	...
	return <main className={className}>
		...
		<header className={`${headerClass==''?' z-20 md:relative text-black bg-white':headerClass} py-4 w-full`}>
			<nav className="container mx-auto flex justify-between px-4">
				...
				<ul dir={lang=='he'?'rtl':'ltr'} className={`${menuOpen?'block motion-safe:animate-menuIn':'hidden md:!translate-x-0'} z-40 text-3xl bg-white md:bg-transparent md:backdrop-blur-none backdrop-blur space-y-4 md:space-y-0 top-0 text-right font-calibri md:font-goodlife fixed md:relative h-screen md:h-auto right-0 w-10/12 md:w-auto md:flex  py-20 md:py-0 px-6 md:px-0  font-bold list-style-none md:space-x-8 md:text-base md:uppercase md:tracking-wider lg:text-lg lg:tracking-widest md:font-bold items-center`}>
