			...
			<div className="container mx-auto px-6 xl:px-0 md:h-[90vh] flex items-center ">
				<div className="sm:grid sm:grid-cols-2 md:grid-cols-3 gap-8">
					...
					<div className="md:col-span-2 pt-5 mb-10 ">
						...
						<a href="/#tours" className="shadow-lg bg-rose-400 block sm:inline-block w-full sm:w-auto sm:inline-block text-center px-8 py-3 rounded-full text-white font-bold hover:bg-rose-500"><FontAwesomeIcon icon={faArrowRight}/> Book a tour with me!</a>
...
export const Head = ({location}) => (<Seo page="about" location={location}/>)
